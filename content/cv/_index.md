...
: Guided senior exec during acquisition and integration.
: Set the AI strategy.
: Unwound and extracted the business from multiple client and vendor contracts.
: Closed the Encapsia Business Unit.

2002 - 2021
: Chief Technology Officer at Cmed Group.
: Designed, built, and supported the world-class and disruptive Clinical Trial
  technology which was used to run almost all work undertaken by Cmed.
: Lead and was responsible for all Technology R&D, System Support, and Corporate IT.
...
: Built a prototype e-commerce system utilising encryption technologies, integrated peripheral hardware (fingerprint devices, mobile phones, barcode scanner and printers, ECG, vital signs and spirometry medical devices).
: Produced fully working demo system in 3 months.
: Sccessfully pitched for fund-raising to create ThirdPhase Ltd.
...
: Doctorate of Philosophy in Artificial Neural Networks.
