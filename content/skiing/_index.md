...
1. 5 short turn drills. See [YouTube](https://youtu.be/NzyaqhzvrI4?si=HhvaQQUGcf3-VJro).
...
1. Double edge pressure ski. See [YouTube](https://youtube.com/shorts/7D20Ws4_88k?si=yl-xJPB_NIZJqbU9).
1. Javelin / stork turns. Transfer weight before switching edge. See [YouTube](https://youtu.be/VO-zVbD-RZs?si=OeC-T0r-catO387W).
1. One legged turns. See [YouTube](https://www.youtube.com/watch?v=NzyaqhzvrI4&t=424s).
...
1. All three joints should be relaxed and flexible - ankles, knees, hips.
1. Be loose. Don’t block any particular movement. Always able to move up, down, left, right.
...
1. Balance (perpendicular) against the slope, not against gravity (vertical). This is dynamic balance in motion.
1. Note the Virtual Bump - the change in steepness due to the turn (so in first half of turn the slope becomes steeper, and second half it becomes less steep). To stay perpendicular in an athletic stance, move forward (or retract skis) in first half, and then reverse that movement in second half. This is a *separate* reason to applying this movement to engage the tips. See [YouTube](https://youtu.be/O8CmZ5spZq0?si=s4PG67w53BqFJpBH).
1. Don’t stick bottom out.
1. Don't sit down.
