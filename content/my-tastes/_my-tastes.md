...
5. Publish reproducible results. I’ve spent the last 25 years using Python for commercial software development, so that will continue to be my go-to tool. Unsurprisingly, Jupyter/Marimo notebooks will feature too.
